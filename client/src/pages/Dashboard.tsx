    ...
    const fetchDashboardData = async () => {
      try {
        const response = await axios.get(
          "https://codsoft-projectmanagement-tool-webapp.vercel.app/v2/auth/dashboard",
          {
            headers: {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center py-6">
        <h1 className="text-3xl sm:text-4xl font-bold text-blue-900 text-center sm:text-left">
          Dashboard 📋
        </h1>
        {loading ? (
      ...
      {loading ? (
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="bg-blue-50 shadow-lg rounded-lg p-4 sm:p-6">
            <h2 className="text-2xl sm:text-3xl text-blue-900">
              Your Personal Tasks
            </h2>
          ...
          <div className="bg-green-50 shadow-lg rounded-lg p-4 sm:p-6">
            <h2 className="text-2xl sm:text-3xl text-green-800">
              Assigned Tasks
            </h2>
            <p className="text-sm sm:text-xl text-gray-700 mt-2 sm:mt-4">
          ...
          <div className="bg-yellow-50 shadow-lg rounded-lg p-4 sm:p-6">
            <h2 className="text-2xl sm:text-3xl text-yellow-800">
              Recent Activities
            </h2>
            <p className="text-sm sm:text-xl text-gray-700 mt-2 sm:mt-4">
          ...
          <div className="bg-orange-50 shadow-lg rounded-lg p-4 sm:p-6">
            <h2 className="text-2xl sm:text-3xl text-orange-800">
              Upcoming Deadlines
            </h2>
            <p className="text-sm sm:text-xl text-gray-700 mt-2 sm:mt-4">
